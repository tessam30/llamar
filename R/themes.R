...
theme_xgrid <- function(font_normal = 'Lato',
                        font_semi = 'Lato Light',
                        font_light = 'Lato Light') {
    theme(title = element_text(size = 16, color = grey90K, family = font_normal), axis.line = element_blank(), 
        axis.ticks.x = element_blank(), axis.text.x = element_text(size = 16, color = grey60K, 
            family = font_light), axis.title.x = element_text(size = 18, color = grey60K, 
            family = font_semi), axis.text.y = element_text(size = 16, color = grey60K, 
            family = font_light), axis.title.y = element_blank(), axis.line.y = element_blank(), 
...
theme_ygrid <- function(font_normal = 'Lato',
    ...
    theme(title = element_text(size = 16, color = grey90K, family = font_normal), plot.title = element_text(hjust = 0), 
        axis.line = element_blank(), axis.ticks.x = element_blank(), axis.text.x = element_text(size = 16, 
            color = grey80K, family = font_light), axis.title.y = element_text(size = 18, 
            color = grey80K, family = font_semi), axis.text.y = element_text(size = 16, 
            color = grey80K, family = font_light), axis.title.x = element_blank(), 
